...
var style_LapakGIS_Batas_Kecamatan_2024_0 = function(feature, resolution){
    ...
    var value = feature.get("Luas Tutupan Hutan Produksi");
    var labelText = "";
    size = 0;
    var labelFont = "10.725px \'Segoe UI Black\', sans-serif";
    var labelFill = "rgba(222, 146, 4, 1)";
    var textAlign = "left";
    var offsetX = 8;
    var offsetY = 3;
    var placement = 'point';
    ...
    if (value > 363.110000 && value <= 3443.668000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 3443.668000 && value <= 6524.226000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 6524.226000 && value <= 9604.784000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 9604.784000 && value <= 12685.342000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 12685.342000 && value <= 15765.900000) {
            style = [ new ol.style.Style({
